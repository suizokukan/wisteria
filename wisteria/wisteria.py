...
def exit_handler():
    ...
    if wisteria.globs.ARGS.exportreport.startswith("md"):
        ...
        with (open(exportreport_filename, "w", encoding="utf-8") as exportedreport,
            ...
            exportedreport.write("```\n")
            exportedreport.write("\n")
            exportedreport.write("![abc](https://github.com/suizokukan/wisteria/blob/task-240/report0/report1.pgn?raw=true)\n")
            exportedreport.write("\n")
            exportedreport.write("![abc](https://github.com/suizokukan/wisteria/blob/task-240/report0/report2.pgn?raw=true)\n")
            exportedreport.write("\n")
            exportedreport.write("![abc](https://github.com/suizokukan/wisteria/blob/task-240/report0/report3.pgn?raw=true)\n")
            exportedreport.write("\n")
            exportedreport.write("![abc](https://github.com/suizokukan/wisteria/blob/task-240/report0/report4.pgn?raw=true)\n")
            exportedreport.write("\n")
